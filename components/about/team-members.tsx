        ...
        >
          {team.map((member, idx) => (
            <motion.div
              key={idx}
              variants={item}
              className="rounded-2xl overflow-hidden bg-card border-2 border-foreground/20 shadow-lg hover:shadow-xl transition-all"
            >
              {/* Photo */}
              <div className="relative bg-muted h-96 flex items-center justify-center overflow-hidden">
                {member.image && (
                  <img
              ...
              <div className="p-6">
                ...
                {!member.quote && (
                  <div className="mb-6 pb-6 border-b border-border/50"></div>
                )}
